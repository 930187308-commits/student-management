...
function downloadFeeTemplate() {
    ...
    const instructionRows = [
        ...
        ['3. 导入时通过学员姓名匹配；找不到学员会在预检中提示，可选择跳过或自动新建学员'],
        ['4. 金额和课时须为数字，异常值会被跳过'],
    ];
